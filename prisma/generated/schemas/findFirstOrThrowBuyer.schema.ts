...
export const BuyerFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BuyerSelect> = z.object({
...
export const BuyerFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    fullName: z.boolean().optional(),
    email: z.boolean().optional(),
    phone: z.boolean().optional(),
...
export const BuyerFindFirstOrThrowSchema: z.ZodType<Prisma.BuyerFindFirstOrThrowArgs> = z.object({ select: BuyerFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BuyerIncludeObjectSchema.optional()), orderBy: z.union([BuyerOrderByWithRelationInputObjectSchema, BuyerOrderByWithRelationInputObjectSchema.array()]).optional(), where: BuyerWhereInputObjectSchema.optional(), cursor: BuyerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BuyerScalarFieldEnumSchema, BuyerScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BuyerFindFirstOrThrowArgs>;

export const BuyerFindFirstOrThrowZodSchema = z.object({ select: BuyerFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BuyerIncludeObjectSchema.optional()), orderBy: z.union([BuyerOrderByWithRelationInputObjectSchema, BuyerOrderByWithRelationInputObjectSchema.array()]).optional(), where: BuyerWhereInputObjectSchema.optional(), cursor: BuyerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BuyerScalarFieldEnumSchema, BuyerScalarFieldEnumSchema.array()]).optional() }).strict();